...
export declare class PaymentsController extends BaseController {
     ...
     */
    authorizationsGet(authorizationId: string, requestOptions?: RequestOptions): Promise<ApiResponse<PaymentAuthorization>>;
    /**
     ...
     * @return Response from the API call
     */
    authorizationsCapture({ authorizationId, paypalRequestId, prefer, body, }: {
     ...
     * @return Response from the API call
     */
    authorizationsVoid({ authorizationId, paypalAuthAssertion, prefer, }: {
        authorizationId: string;
     ...
     * @return Response from the API call
     */
    authorizationsReauthorize({ authorizationId, paypalRequestId, prefer, body, }: {
        authorizationId: string;
        paypalRequestId?: string;
        prefer?: string;
     ...
     * @return Response from the API call
     */
    refundsGet(refundId: string, requestOptions?: RequestOptions): Promise<ApiResponse<Refund>>;
}
