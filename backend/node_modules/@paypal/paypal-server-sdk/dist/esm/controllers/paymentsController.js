...
export class PaymentsController extends BaseController {
     ...
     */
    async authorizationsGet(authorizationId, requestOptions) {
     ...
     * @return Response from the API call
     */
    async authorizationsCapture({ authorizationId, paypalRequestId, prefer, body, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async authorizationsVoid({ authorizationId, paypalAuthAssertion, prefer, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            authorizationId: [authorizationId, string()],
     ...
     * @return Response from the API call
     */
    async authorizationsReauthorize({ authorizationId, paypalRequestId, prefer, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            authorizationId: [authorizationId, string()],
            paypalRequestId: [paypalRequestId, optional(string())],
     ...
     * @return Response from the API call
     */
    async refundsGet(refundId, requestOptions) {
        const req = this.createRequest('GET');
