...
export declare class OrdersController extends BaseController {
     ...
     * @return Response from the API call
     */
    ordersCreate({ body, paypalRequestId, paypalPartnerAttributionId, paypalClientMetadataId, prefer, }: {
        body: OrderRequest;
        paypalRequestId?: string;
     ...
     * @return Response from the API call
     */
    ordersConfirm({ id, paypalClientMetadataId, prefer, body, }: {
        id: string;
        paypalClientMetadataId?: string;
        prefer?: string;
     ...
     * @return Response from the API call
     */
    ordersTrackersPatch({ id, trackerId, body, }: {
        id: string;
        trackerId: string;
        body?: Patch[];
    }, requestOptions?: RequestOptions): Promise<ApiResponse<void>>;
