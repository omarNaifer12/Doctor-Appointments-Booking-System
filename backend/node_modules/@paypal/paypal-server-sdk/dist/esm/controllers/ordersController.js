...
export class OrdersController extends BaseController {
     ...
     * @return Response from the API call
     */
    async ordersCreate({ body, paypalRequestId, paypalPartnerAttributionId, paypalClientMetadataId, prefer, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async ordersPatch({ id, body, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async ordersGet({ id, fields, }, requestOptions) {
     ...
     * @return Response from the API call
     */
    async ordersConfirm({ id, paypalClientMetadataId, prefer, body, }, requestOptions) {
        const req = this.createRequest('POST');
        const mapped = req.prepareArgs({
            id: [id, string()],
            paypalClientMetadataId: [paypalClientMetadataId, optional(string())],
     ...
     * @return Response from the API call
     */
    async ordersTrackersPatch({ id, trackerId, body, }, requestOptions) {
        const req = this.createRequest('PATCH');
        const mapped = req.prepareArgs({
            id: [id, string()],
